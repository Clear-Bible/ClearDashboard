...
namespace ClearDashboard.DAL.Tests
{
    ...
    public class GetVersificationAndBookIdByParatextPluginIdTests : TestBase
    {
        ...
        {
            var results =
                await ExecuteParatextAndTestRequest<GetVersificationAndBookIdByDalParatextProjectIdQuery,
                    RequestResult<VersificationBookIds>, VersificationBookIds>(
                    new GetVersificationAndBookIdByDalParatextProjectIdQuery("3f0f2b0426e1457e8e496834aaa30fce00000002abcdefff"));
