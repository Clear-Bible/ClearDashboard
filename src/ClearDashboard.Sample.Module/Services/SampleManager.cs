...
using static ClearDashboard.Sample.Module.Services.ISampleManager;
...
namespace ClearDashboard.Sample.Module.Services
{
    public class SampleManager : ISampleManager
    {
        ...
        protected ILogger<SampleManager>? logger_;
        ...
        public async Task<string> AddVersion(
            ...
            ISampleManager.Version version,
        ...
        public async Task<IEnumerable<ISampleManager.Version>?> ListVersions(
            CancellationToken cancellationToken = default)
        {
            return await GetFromJsonAsync<IEnumerable<ISampleManager.Version>>(
                httpClient_,
                versionPath_,
