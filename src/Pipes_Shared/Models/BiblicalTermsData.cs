...
namespace ParaTextPlugin.Data.Models
{
    public class BiblicalTermsData : ObservableObject
    {
        ...
        {
            get => _semanticDomain;
            set => SetProperty(ref _semanticDomain, value);
        }
        ...
        {
            get => _localGloss;
            set => SetProperty(ref _localGloss, value);
        }
        ...
        {
            get => _linkString;
            set => SetProperty(ref _linkString, value);
        }
        ...
        {
            get => _referencesList;
            set => SetProperty(ref _referencesList, value);
        }
        ...
        public List<string> ReferencesLong
        {
            ...
            set => SetProperty(ref _referencesListLong, value);
        }
        ...
        public List<string> ReferencesListText
        {
            ...
            set => SetProperty(ref _referencesListText, value);
        }
        ...
        {
            get => _renderings;
            set => SetProperty(ref _renderings, value);
        }

        private string _renderingString;
        public string RenderingString
        {
            get => _renderingString;
            set => SetProperty(ref _renderingString, value);
        }
        ...
        {
            get => _renderingCount;
            set => SetProperty(ref _renderingCount, value);
        }
