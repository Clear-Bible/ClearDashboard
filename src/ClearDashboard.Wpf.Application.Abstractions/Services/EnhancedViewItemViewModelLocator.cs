...

{
    ...
    /// </summary>
    public static class EnhancedViewItemViewModelLocator
    {
        const string DefaultViewSuffix = "View";


        static readonly ILog Log = LogManager.GetLog(typeof(EnhancedViewItemViewModelLocator));
        ...
        static EnhancedViewItemViewModelLocator()
        {
        ...
        /// </remarks>
        public static Func<object, object> LocateForMetadatum = metadatum =>
        {
            if (metadatum == null)
            {
                return null;
            ...
            var frameworkElement = metadatum as FrameworkElement;
            if (frameworkElement != null && frameworkElement.DataContext != null)
            {
                return frameworkElement.DataContext;
            }

            return LocateForViewType(metadatum.GetType());
