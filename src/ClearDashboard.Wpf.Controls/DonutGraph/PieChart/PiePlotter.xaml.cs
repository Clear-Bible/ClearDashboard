...
using ClearDashboard.Wpf.Controls.DonutGraph.Shapes;
    ...
    public partial class PiePlotter : UserControl
    {
        ...
        private void ConstructPiePieces()
        {
            ...
            foreach (Object item in myCollectionView)
            {
                ...
                //Debug.WriteLine("===========================");
                //Debug.WriteLine($"Tag: {piece.Tag}");
                //Debug.WriteLine($"Radius: {piece.Radius}");
                //Debug.WriteLine($"CentreX: {piece.CentreX}");
                //Debug.WriteLine($"CentreY: {piece.CentreY}");
                //Debug.WriteLine($"Wedge Angle: {piece.WedgeAngle}");
                //Debug.WriteLine($"RotationAngle: {piece.RotationAngle}");
                //Debug.WriteLine($"PieceValue: {piece.PieceValue}");
