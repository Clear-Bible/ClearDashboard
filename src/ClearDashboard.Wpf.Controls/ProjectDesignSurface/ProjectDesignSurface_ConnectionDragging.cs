...
namespace ClearDashboard.Wpf.Controls
{
    ...
    public partial class ProjectDesignSurface
    {
        ...
        private void ConnectorItem_Dragging(object source, ConnectorItemDraggingEventArgs e)
        {
            ...
            var dragOverSuccess = DetermineConnectorItemDraggedOver(mousePoint, out var connectorDraggedOver, out var connectorDataContextDraggedOver);
        ...
        private void ConnectorItem_DragCompleted(object source, ConnectorItemDragCompletedEventArgs e)
        {
            ...
            //
            DetermineConnectorItemDraggedOver(mousePoint, out var connectorDraggedOver, out var connectorDataContextDraggedOver);
        ...
        private bool DetermineConnectorItemDraggedOver(Point hitPoint, out ConnectorItem connectorItemDraggedOver, out object connectorDataContextDraggedOver)
        {
            ...
            var projectDesignSurface = connectorItem.ParentProjectDesignSurface;
