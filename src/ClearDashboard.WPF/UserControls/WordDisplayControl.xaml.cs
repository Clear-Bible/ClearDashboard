...
{
    /// <summary>
    /// A control for displaying a single word composed of tokens.
    /// </summary>
    public partial class WordDisplayControl : UserControl
    {
        ...
        public Thickness InnerPadding => StackPadding;
