...
namespace ClearDashboard.Wpf.Helpers
{
    public static class Helpers
    {
        ...
        //    if (value.Length >= 9)
        //    {
        //        string sBook = GetFullBookNameFromBookNum(value.Substring(0, 3));
        //        string sChap = Convert.ToInt32(value.Substring(3, 3)).ToString();
        //        string sVerse = Convert.ToInt32(value.Substring(6, 3)).ToString();
