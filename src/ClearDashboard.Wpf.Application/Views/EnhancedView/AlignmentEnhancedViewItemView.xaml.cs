...
{
    /// <summary>
    /// Interaction logic for AlignmentEnhancedViewItemView.xaml
    /// </summary>
    public partial class AlignmentEnhancedViewItemView : UserControl
    {
        public AlignmentEnhancedViewItemView()
        {
            InitializeComponent();
        }
