...
namespace ClearDashboard.Wpf.Application.UserControls.Notes
{
    ...
    public partial class NoteRepliesDisplay : INotifyPropertyChanged
    {
        ...
        private void NoteReplyTextBox_OnPreviewKeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Enter && Keyboard.Modifiers == ModifierKeys.Shift)
            {
                NoteReplyTextBox.Text = NoteReplyTextBox.Text + "\n";
                // put the cursor at the end of the text
                NoteReplyTextBox.CaretIndex = NoteReplyTextBox.Text.Length;
                e.Handled = true;
            }
        }
    }
