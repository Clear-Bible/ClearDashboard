...
namespace ClearDashboard.Wpf.Application.UserControls
{
    ...
    /// </summary>
    public class AnchoredPopup : Popup
    {
        /// <summary>
        /// Is Topmost dependency property
        /// </summary>
        public static readonly DependencyProperty IsTopmostProperty = DependencyProperty.Register(nameof(IsTopmost), 
                                                                                        typeof(bool), 
                                                                                        typeof(AnchoredPopup), 
        ...
        private void OnParentWindowDeactivated(object? sender, EventArgs e)
        {
            ...
            if (IsTopmost == false) { SetTopmostState(IsTopmost); }
        }
        ...
        {
            var nonTopmostPopup = (AnchoredPopup)obj;
            nonTopmostPopup.SetTopmostState(nonTopmostPopup.IsTopmost);
        }

        protected override void OnOpened(EventArgs e)
        {
            SetTopmostState(IsTopmost); base.OnOpened(e);
        }
        ...
        private void SetTopmostState(bool isTop)
        {
            ...
            else
            {
                ...
                // then HWND_TOP before HWND_NOTOPMOST SetWindowPos(hwnd, HWND_BOTTOM, rect.Left, rect.Top, (int)Width, (int)Height, TOPMOST_FLAGS); 
        ...
        //Xml-doc #pragma warning disable 169
        //Never used-warning
