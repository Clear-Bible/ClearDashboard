...
namespace ClearDashboard.Wpf.Application.UserControls.Lexicon
{
    ...
    /// </summary>
    public partial class GlossListDisplay : INotifyPropertyChanged, IHandle<LexiconTranslationMovedMessage>
    {
        ...
        public static readonly RoutedEvent TranslationAddedEvent = EventManager.RegisterRoutedEvent
            (nameof(TranslationAdded), RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(GlossListDisplay));
        ...
        public static readonly RoutedEvent NewTranslationChangedEvent = EventManager.RegisterRoutedEvent
            (nameof(NewTranslationChanged), RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(GlossListDisplay));
        ...
        (nameof(TranslationSelected), RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(GlossListDisplay));
        ...
        public static readonly DependencyProperty NewTranslationProperty = 
            DependencyProperty.Register(nameof(NewTranslation), typeof(LexiconTranslationViewModel), typeof(GlossListDisplay), new PropertyMetadata(null, OnNewTranslationPropertyChanged));
        ...
        public static readonly DependencyProperty TranslationFontFamilyProperty = DependencyProperty.Register(
            nameof(TranslationFontFamily), typeof(FontFamily), typeof(GlossListDisplay),
        ...
        public static readonly DependencyProperty TranslationFontSizeProperty = DependencyProperty.Register(
            nameof(TranslationFontSize), typeof(double), typeof(GlossListDisplay),
        ...
        public static readonly DependencyProperty TranslationFontStyleProperty = DependencyProperty.Register(
            nameof(TranslationFontStyle), typeof(FontStyle), typeof(GlossListDisplay),
        ...
        public static readonly DependencyProperty TranslationFontWeightProperty = DependencyProperty.Register(
            nameof(TranslationFontWeight), typeof(FontWeight), typeof(GlossListDisplay),
        ...
        public static readonly DependencyProperty TranslationMarginProperty = DependencyProperty.Register(
            nameof(TranslationMargin), typeof(Thickness), typeof(GlossListDisplay),
        ...
        public static readonly DependencyProperty TranslationPaddingProperty = DependencyProperty.Register(
            nameof(TranslationPadding), typeof(Thickness), typeof(GlossListDisplay),
        ...
        {
            var display = d as GlossListDisplay;
