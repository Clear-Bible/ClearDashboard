        ...
        private async Task Import()
        {
            ...
            try
            {
                ...
                _runningTask = Task.Run(async () => {
					...
					var tokenizedTextCorpus = await TokenizedTextCorpus.GetAsync(LifetimeScope!, TokenizedTextCorpusId!);
					await tokenizedTextCorpus.ImportWordAnalysesAsync(LifetimeScope!, _cancellationTokenSource.Token);
