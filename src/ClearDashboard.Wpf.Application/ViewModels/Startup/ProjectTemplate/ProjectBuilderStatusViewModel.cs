...
public partial class ProjectBuilderStatusViewModel : Screen, IHandle<BackgroundTaskChangedMessage>, IHandle<ToggleBackgroundTasksVisibilityMessage>
{
    ...
    public ProjectBuilderStatusViewModel(LongRunningTaskManager? longRunningTaskManager, IEventAggregator? eventAggregator, ILogger<BackgroundTasksViewModel> logger, ILocalizationService localizationService)
    {
