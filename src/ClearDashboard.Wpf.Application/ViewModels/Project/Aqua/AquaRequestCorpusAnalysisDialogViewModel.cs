...
{
    public class AquaRequestCorpusAnalysisDialogViewModel : DashboardApplicationWorkflowShellViewModel, IAquaDialogViewModel
    {
        ...
        private Visibility _showSpinner = Visibility.Hidden;
            ...
            : base(projectManager, navigationService, logger, eventAggregator, mediator, lifetimeScope)
        {
            ...
            ErrorTitle = Helpers.LocalizationStrings.Get("AquaRequestCorpusAnalysisDialog_NoErrors", logger_);
        }
