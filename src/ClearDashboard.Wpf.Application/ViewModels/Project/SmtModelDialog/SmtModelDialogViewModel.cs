        ...
        protected override async Task OnInitializeAsync(CancellationToken cancellationToken)
        {
            ...
            if (views == null || !views.Any())
            {
                throw new DependencyRegistrationMissingException(
                    "There are no dependency inject registrations of 'IWorkflowStepViewModel' with the key of 'SmtModelDialog'.  Please check the dependency registration in your bootstrapper implementation.");
            }
