...
{
    public class ReleaseNotesViewModel : DashboardApplicationScreen 
        //IShellViewModel,
        ...
        //IHandle<GetApplicationWindowSettings>
    {
        ...
        public ReleaseNotesViewModel(TranslationSource? translationSource, INavigationService navigationService,
            ILogger<ReleaseNotesViewModel> logger, DashboardProjectManager? projectManager, IEventAggregator eventAggregator,
            ...
            : base(projectManager, navigationService, logger, eventAggregator, mediator, lifetimeScope)
        {
            ...
            Logger.LogInformation("'ReleaseNotesViewModel' ctor called.");
        ...
        //{
        //    //DeterminePopupHorizontalOffset((ReleaseNotesView)view);
        ...
        //{
        //    //NavigationService!.Navigated -= NavigationServiceOnNavigated;
        //    Logger!.LogInformation($"{nameof(ReleaseNotesViewModel)} is deactivating.");
