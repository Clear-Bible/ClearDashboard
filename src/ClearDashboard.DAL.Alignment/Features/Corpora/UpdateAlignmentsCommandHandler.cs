        ...
        AlignmentSet>
    {
        ...
        protected override async Task<RequestResult<AlignmentSet>> SaveDataAsync(UpdateAlignmentsCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var oldAlignmentSet = await AlignmentSet.Get(request.AlignmentSetsToRedo, _mediator);
                ...
                await AlignmentUtil.InsertAlignmentsAsync(
                    ...
                    request.AlignmentSetsToRedo.Id,
                ...
                var redoneAlignmentSetModel = new Models.AlignmentSet
                {
                    ...
                    ParallelCorpusId = request.AlignmentSetsToRedo.ParallelCorpusId.Id,
                    DisplayName = displayName,
                    SmtModel = request.AlignmentSetsToRedo.SmtModel,
                    IsSyntaxTreeAlignerRefined = request.AlignmentSetsToRedo.IsSyntaxTreeAlignerRefined,
                    IsSymmetrized = request.AlignmentSetsToRedo.IsSymmetrized,
                ...
                {
                    AlignmentSetId = request.AlignmentSetsToRedo.Id
                });
