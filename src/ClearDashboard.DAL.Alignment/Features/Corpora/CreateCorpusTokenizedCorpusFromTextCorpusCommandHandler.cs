...
{
    public class CreateCorpusTokenizedCorpusFromTextCorpusCommandHandler : ProjectDbContextCommandHandler<
        CreateCorpusTokenizedCorpusFromTextCorpusCommand,
        RequestResult<TokenizedTextCorpus>,
        TokenizedTextCorpus>
    {
        private readonly IMediator _mediator;

        public CreateCorpusTokenizedCorpusFromTextCorpusCommandHandler(IMediator mediator,
        ...
        protected override async Task<RequestResult<TokenizedTextCorpus>> SaveDataAsync(
            CreateCorpusTokenizedCorpusFromTextCorpusCommand request, CancellationToken cancellationToken)
        {
            //DB Impl notes:
            // 1. creates corpus
            // 2. creates a new associated TokenizedCorpus (associated with the parent CorpusId provided in the request),
