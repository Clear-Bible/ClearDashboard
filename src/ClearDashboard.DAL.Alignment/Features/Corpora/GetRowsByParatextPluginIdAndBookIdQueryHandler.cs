...
{
    public class GetRowsByParatextPluginIdAndBookIdQueryHandler : AlignmentDbContextQueryHandler<
        ...
        IEnumerable<(string chapter, string verse, string text, bool isSentenceStart)>>
    {
        ...
        protected override Task<RequestResult<IEnumerable<(string chapter, string verse, string text, bool isSentenceStart)>>> GetData(GetRowsByParatextPluginIdAndBookIdQuery request, CancellationToken cancellationToken)
        {
