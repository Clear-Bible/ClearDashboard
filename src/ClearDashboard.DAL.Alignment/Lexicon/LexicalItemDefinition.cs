...
{
    public class LexicalItemDefinition
    {
        public LexicalItemDefinitionId? LexicalItemDefinitionId
        {
            get;
#if DEBUG
            internal set;
        ...
        {
            if (LexicalItemDefinitionId is null)
            {
                throw new MediatorErrorEngineException("'CreateOrUpdate LexicalItemDefinition before associating with SemanticDomain");
            }
        ...
        public async Task AssociateSemanticDomain(IMediator mediator, SemanticDomain semanticDomain, CancellationToken token = default)
        {
            ...
            if (LexicalItemDefinitionId is null)
            {
                throw new MediatorErrorEngineException("Create LexicalItemDefinition before associating with given SemanticDomain");
            }
            if (semanticDomain.SemanticDomainId is null)
            {
                throw new MediatorErrorEngineException("Create given SemanticDomain before associating with LexicalItemDefinition");
            }

            var command = new CreateSemanticDomainLexicalItemDefinitionAssociationCommand(semanticDomain.SemanticDomainId, LexicalItemDefinitionId);
        ...
        public async Task DetachSemanticDomain(IMediator mediator, SemanticDomain semanticDomain, CancellationToken token = default)
        {
            ...
            if (LexicalItemDefinitionId is null)
            {
                throw new MediatorErrorEngineException("Cannot detach semantic domain before LexicalItemDefinition has been created");
            }
            if (semanticDomain.SemanticDomainId is null)
            {
            ...
            var command = new DeleteSemanticDomainLexicalItemDefinitionAssociationCommand(semanticDomain.SemanticDomainId, LexicalItemDefinitionId);
        ...
        {
            if (LexicalItemDefinitionId == null)
            {
                return;
            }

            var command = new DeleteLexicalItemDefinitionCommand(LexicalItemDefinitionId);
